<?php  
		...
		try 
		{
			...
			$select = $conexao2->prepare('SELECT * FROM tb_cliente');
			$select->execute();
  ...
  <tr>
    ...
    <th>CEP</th>
			...
			<tr>
				...
				onclick="javascript: location.href='excluir_cliente.php?codigo=<?php echo $row['cd_cliente'];?>'" />
				Excluir
				</td>
				...
				onclick="javascript: location.href='alterar_cliente.php?codigo=<?php echo $row['cd_cliente'];?>'" />
				Alterar
				</td>
