<?php  
		...
		try 
		{
			...
			$select = $con->prepare('SELECT * FROM tb_funcio');
			$select->execute();
  ...
  <tr>
    ...
    <th>CEP</th>
			...
			<tr>
				...
				onclick="javascript: location.href='excluir_funcio.php?codigo=<?php echo $row['cd_funcio'];?>'" />
				Excluir
				</td>
				...
				onclick="javascript: location.href='alterar_funcio.php?codigo=<?php echo $row['cd_funcio'];?>'" />
				Alterar
				</td>
